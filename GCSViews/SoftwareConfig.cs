    ...
    public partial class SoftwareConfig : MyUserControl, IActivate
    {
        ...
        private void SoftwareConfig_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (MainV2.Advanced)                //UAVSMOD - display config options based on advanced setting
                    {
                        if (MainV2.Advanced) AddBackstageViewPage(new ConfigFlightModes(), Strings.FlightModes);
